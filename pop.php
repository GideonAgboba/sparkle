...
<div class="card-content">
<span class="card-title activator green-body text-center text-white container p-1">Pay On Delivery <i class="fa fa-handshake-o text-white"></i></span>


</div>
<div class="card-reveal">
<span class="card-title green-font">Make payments on delivery <i class="fa fa-angle-down"></i> <i class="fa fa-close right text-muted"></i></span>
<div class="text-centertext-white">
	<?php include 'pod.php'; ?>
</div>
</div>
