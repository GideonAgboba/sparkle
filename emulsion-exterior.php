    		...
    		$output = NULL;
              if (isset($_POST["search_eml_ext"])) {
                $search_eml_ext = $_POST["search_eml_ext"];
			$queryelm = "SELECT * FROM emulsion_exterior WHERE title = '$search_eml_ext'";
  ...
  if (confirm("Are you done shopping?")) {
    ...
    window.location = 'index.php';
      ...
      <nav class="navbar-expand white fixed-top">
      	...
      	<input type="text" name="search_eml_ext" class="form-control validate text-center" placeholder="search item" value="<?php if(isset($_POST['search_eml_ext'])){ echo $_POST['search_eml_ext'];} ?>">
      		<?php echo $output; ?>
      	</form>
