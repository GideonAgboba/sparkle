    		...
    		$output = NULL;
              if (isset($_POST["search_eml_int"])) {
                $search_eml_int = $_POST["search_eml_int"];
			$queryelm = "SELECT * FROM emulsion_interior WHERE title = '$search_eml_int'";
  ...
  if (confirm("Are you done shopping?")) {
    ...
    window.location = 'index.php';
      ...
      <nav class="navbar-expand white fixed-top">
      	...
      	<input type="text" name="search_eml_int" class="form-control validate text-center" placeholder="search item" value="<?php if(isset($_POST['search_eml_int'])){ echo $_POST['search_eml_int'];} ?>">
      		<?php echo $output; ?>
      	</form>
