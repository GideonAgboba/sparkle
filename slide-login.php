    <h2 style="font-weight: bold;color: #fff;">QUICK NOTICE:</h2>
<aside class="profile-car">
  <div class="container">
    <div id="auto" class="text-center text-white home-story">
    <div>
      <p class="text-center text-white">
        <ul>
          <li>Information used on sign-up should be the information required to check out after purchase.</li>
        </ul>
      </p>
    </div>
    <div>
