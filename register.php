...
if ( $result->num_rows > 0 ) {
    ...
    $_SESSION['message'] = 'Password dosent match!';
    header("location: error.php");
}
else { // Email doesn't already exist in a database, proceed...

    // active is 0 by DEFAULT (no need to include it here)
    $sql = "INSERT INTO users (first_name, last_name, email, password, hash, phone) " 
            . "VALUES ('$first_name','$last_name','$email','$password', '$hash', '$phone')";
